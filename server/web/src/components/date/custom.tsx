...
export function customDate({form, onSubmit} : { form: UseFormReturn<TInputs>, onSubmit: SubmitHandler<TInputs> }) {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className="col-span-2" type="number" min={1} {...field} />
                </FormControl>
                <FormDescription>
        ...
        
        {
          repeatEvery === RepeatEvery.Week && (
            <div className="grid grid-cols-1 gap-2">
              <WeekDay name="weekDayForMonth" register={form.register} multiple={true} />
            </div>
          )
        }
...
function WeekDay({name, multiple, register}: { name: FieldPath<TInputs>, register: UseFormRegister<TInputs>, multiple: boolean }) {
    return (
