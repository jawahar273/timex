...
* @returns {any}
*/
export function show_detail_in_display(_detail) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.show_detail_in_display(retptr, addHeapObject(_detail));
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('asm-9dbf0d2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
